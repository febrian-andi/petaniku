...
<html lang="en-US" dir="ltr">
  ...
  <head>
    ...
    <title>Petaniku | Mulai Alur</title>
  ...
  <body>
    <main class="main" id="top">
        <nav class="navbar navbar-expand-lg navbar-light fixed-top p-2 bg-light">
            <a href="{{ route('workflow.detail') }}"><span class="iconify ms-4" data-icon="mdi:arrow-left" style="font-size: 40px;"></span></a>
            <div class="mx-auto text-center">
              <h5 class="fw-light" style="color: #4fc358">Mulai Alur</h5>
            </div>
        </nav>
            ...
            <div class="container">
                <form>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="waktuMulai" value="1 Januari 2023" required>
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mx-auto text-end">
                        <a href="{{ route('workflow.detail') }}" class="btn btn-danger me-auto">Batal</a>
                        <a type="submit" class="btn" style="background-color: #0BAC56; color:white;">Mulai</a>
                    </div>                  
                </form>
            </div>
        </section>
