...
Route::middleware('auth')->group(function () {
    ...
    Route::get('/workflow-detail', [WorkflowController::class, 'workflow_detail'])->name('workflow.detail');
    Route::get('/workflow-detail/task-tittle', [WorkflowController::class, 'workflow_task_detail'])->name('workflow.task.detail');
